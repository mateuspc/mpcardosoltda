...
const apps = [
  ...
  { icon: Activity, name: 'ClearWave Pro', label: 'Utilitário de áudio', copy: 'Ciclos de tons graves e varreduras de frequência para ajudar a deslocar gotas na saída do alto-falante.', highlight: 'Android + iOS', href: '/clearwave/' },
...
function App() {
  return <main id="top">
    ...
    <footer><div className="brand"><span className="brand-mark"><img src="/brand-icon.png" alt="" /></span><span><strong>M P Cardoso Solutions</strong><small>Software que chega ao mercado.</small></span></div><div><a href="/pitchpro/">PitchPro</a><a href="/delay-reverb/">Delay &amp; Reverb Pro</a><a href="/car-audio-box/">Car Audio Box</a><a href="/clearwave/">ClearWave Pro</a><a href="/privacy/">Política de Privacidade</a><a href="/terms/">Termos de Uso</a><a href="/support/">Suporte</a><a href="/contact/">Contato</a></div><p>© 2026 M P Cardoso Solutions · CNPJ 61.798.348/0001-60</p></footer>
  </main>
}
